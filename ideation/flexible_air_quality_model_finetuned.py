"""
Flexible Air Quality Model with Fine-tuning Capabilities
======================================================
...
Usage:
    model = FlexibleAirQualityModelFinetuned("my_experiment")
...
class FlexibleAirQualityModelFinetuned:
    """
    Enhanced XGBoost model with fine-tuning capabilities and overfitting prevention
    """
    ...
    def train_with_validation(self, train_file_path, validation_split=0.2, optimize_params=True):
        ...
        """
        print("=" * 60)
        print(f"TRAINING {self.model_name.upper()} WITH FINE-TUNING")
        print("=" * 60)
...
def main():
    ...
    print("=" * 60)
    print("FLEXIBLE AIR QUALITY MODEL WITH FINE-TUNING - EXAMPLE USAGE")
    print("=" * 60)
    
    # Create model instance
    model = FlexibleAirQualityModelFinetuned("finetuned_validation_model")
    ...
    predictions, submission = model.predict(
        "test_simplified.csv", 
        "predictions_finetuned_2023.csv"
    )
    ...
    print("\n" + "=" * 60)
    print("FINE-TUNED MODEL COMPLETED!")
    print("=" * 60)
