...
def validate_finetuned_model():
    """Train fine-tuned model and validate on September 2023 data"""
    
    print("=" * 60)
    print("VALIDATING FINE-TUNED MODEL ON SEPTEMBER 2023 DATA")
    print("=" * 60)
    
    # Create fine-tuned model
    model = FlexibleAirQualityModelFinetuned("ideation_finetuned_validation")
    
    # Train with validation and hyperparameter optimization
    print("\n1. Training fine-tuned model with validation...")
    ...
    print("(September 3-24, 2024) with fine-tuning and overfitting prevention.")
    print("=" * 60)
...
if __name__ == "__main__":
    mae_scores, overall_score = validate_finetuned_model()
